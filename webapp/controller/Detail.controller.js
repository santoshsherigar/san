sap.ui.define([
	...
	return BaseController.extend("utg.app.OrderDetail.controller.Detail", {
		...
		handleItemPress: function (oEvent) {
			...
			// 	orderPath = oEvent.getSource().getBindingContext("orders").getPath(),
			// 	order = orderPath.split("/").slice(-1).pop();

			// this.oRouter.navTo("detailDetail", {layout: oNextUIState.layout,
			// 	product: this._orders, order: order});	
			var oSelectedItem = oEvent.getSource();
			// var oContext = oSelectedItem.getBindingContextPath();
			// var orderPath = oContext.getPath();

			// var orderPath = oEvent.getSource().getBindingContext("Orders").getPath(),
			// var product = oSelectedItem.getBindingContextPath().split("ProductID=")[1].slice(0, -1); //one way of getting
			var product = oSelectedItem.getBindingContext().getProperty("ProductID");
